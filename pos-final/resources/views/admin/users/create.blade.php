              ...
              <div class="card-body">
                  ...
                  <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="name" id="name" class="form-control" placeholder="Example: Joko Boyo" value="{{ old('name') }}" autofocus>
                      @error('name')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" name="email" id="email" class="form-control" placeholder="Example: joko@gmail.com" value="{{ old('email') }}" >
                      @error('email')
                        <div class="text-danger small">{{ $message }}</div>
                      @enderror
                    </div>
