    ...
    <div class="flex-grow flex">
      ...
      <div class="flex flex-col bg-blue-gray-50 h-full w-full py-4">
        ...
        <div class="flex items-center px-2 relative">
          ...
          <!-- Tombol ke Dashboard -->
          <a href="/" class="absolute left-5 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-blue-600 hover:bg-blue-700 text-white shadow">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9l9-7 9 7v11a2 2 0 01-2 2h-4a2 2 0 01-2-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h4a2 2 0 002-2v-4" />
            </svg>
          </a>
        
          <!-- Icon Search -->
          <div class="absolute left-20 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-gray-100 text-gray-600">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
