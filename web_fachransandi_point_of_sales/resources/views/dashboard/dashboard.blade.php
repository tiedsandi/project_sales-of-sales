    ...
    <div class="col-lg-4">
      <div class="col-md-12">
        <div class="card info-card products-card">
          ...
          <div class="card-body">
            <h5 class="card-title">Top Products <span>| Sold</span></h5>
      
            <div class="d-flex flex-column">
              @foreach($TopProducts as $item)
                <div class="d-flex align-items-center mb-2">
                  <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    <img src="{{ asset('storage/' . $item->product->product_photo) }}" alt="{{ $item->product->product_name }}" width="50">

                  </div>
                  <div class="ps-3">
                    <h6 class="mb-0">{{ $item->product->product_name }}</h6>
                    <small class="text-muted">{{ $item->total_qty }} pcs sold</small>
                  </div>
                </div>
              @endforeach
            </div>
